...
You will find several ways of working with counters https://docs.couchbase.com/sdk-api/couchbase-python-client-2.5.12/api/couchbase.html#counter-operations[in the API docs].
////
