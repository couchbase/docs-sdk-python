...
From Couchbase Python.js SDK 2.5.1, [.api]`AlternateAddress` is implemented, for connecting to nodes in a NATed environment, such as Docker containers using portmapping.
