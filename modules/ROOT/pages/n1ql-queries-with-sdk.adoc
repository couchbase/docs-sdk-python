...
xref:4.5@server:n1ql:n1ql-language-reference/createindex.adoc[CREATE INDEX]) or via the Python SDK's xref:managing-clusters.adoc[cluster management interface]
