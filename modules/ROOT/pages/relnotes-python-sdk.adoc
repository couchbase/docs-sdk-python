...
* https://issues.couchbase.com/browse/PYCBC-522[PYCBC-522] - Fix
remaining lost spans
...
Due to a known issue [PYCBC-522]: In this release, Response Time
Observability and tracing are available, but off by default due to
tracing contexts being lost in some instances.
...
* https://issues.couchbase.com/browse/PYCBC-504[PYCBC-504] - In
python 3.7 'async' is a keyword. The package 'couchbase.async' have
to be renamed
