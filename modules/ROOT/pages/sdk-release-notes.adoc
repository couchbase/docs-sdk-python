...
Expose settings for compression min_size/min_ratio as documented in RFC

* https://issues.couchbase.com/browse/PYCBC-565[PYCBC-565]:
Python gcouchbase timeout error when attempting to connect to a bucket with authentication
