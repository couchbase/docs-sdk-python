...
:page-partial:
:page-aliases: relnotes-python-sdk,download-links,release-notes
...
Augment Search, Admin and ClusterManager API docs and index.

* https://issues.couchbase.com/browse/PYCBC-581[PYCBC-581]:
Document metric/meta properties for N1QLRequest, and update Analytics docs
