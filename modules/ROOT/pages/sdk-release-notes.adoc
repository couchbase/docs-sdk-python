...
:page-partial:
:page-aliases: relnotes-python-sdk,sdk-release-notes
...
New versions of the Python SDK take advantage of features added in recent versions of libcouchbase. Be sure to xref:2.10@c-sdk::relnotes-c-sdk.adoc[upgrade your LCB installation] before making a major upgrade to the Couchbase Python client.
