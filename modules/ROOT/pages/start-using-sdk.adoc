...
*Due to API/language changes and compiler support, we support a subset of all Python platforms. Please see
xref:compatibility-versions-features.adoc[the compatibility page] for details.*
