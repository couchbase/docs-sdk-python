...
The Collections feature in Couchbase Server 7.0 is fully implemented in the Python SDK version 4.x.
...
[source,scala]
----
include::devguide:example$python/CollectionsExample.scala[tag=collections_1,indent=0]
----

And for a non-default scope:
[source,scala]
----
include::devguide:example$python/CollectionsExample.scala[tag=collections_2,indent=0]
----
