...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=create-simple,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=rollback_cause,indent=0]
----
...
//[source,python]
//----
//include::devguide:example$python/transactions_example.py[tag=custom_metadata,indent=0]
//----
//
...
//[source,java]
//----
//include::devguide:example$python/transactions_example.py[tag=custom_metadata_per,indent=0]
//----
//
