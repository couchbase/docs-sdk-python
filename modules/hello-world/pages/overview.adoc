...
// and code samples from https://github.com/couchbase/docs-sdk-python/tree/release/4.6/modules/devguide/examples/python/
// 
// It can be seen built at https://docs.couchbase.com/python-sdk/4.6/hello-world/overview.html
// 
...
[source,python]
----
include::devguide:example$python/n1ql_ops.py[tag=named_options,indent=0]
----
--
...
* https://developer.couchbase.com/tutorial-quickstart-flask-python/[Python with Flask tutorial]
* xref:3.5@spark-connector:ROOT:pyspark.adoc[Apache Spark Connector]
* https://github.com/couchbase-examples/couchbase-jupyter-labs/[Couchbase Jupyter Labs]
...
* For real-time analytics, see our xref:python-analytics-sdk:hello-world:overview.adoc[Enterprise Analytics Python SDK]
