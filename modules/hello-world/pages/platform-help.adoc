...
If you are running Windows, skip to the Windows section.
But if you are developing for an older platform -- such as an old Red Hat installation -- then read on.

You most likely already have python installed on your development machine.
...
// venv
// 
// see also: https://stackoverflow.com/questions/41573587/what-is-the-difference-between-venv-pyvenv-pyenv-virtualenv-virtualenvwrappe



=== Installing on GNU/Linux

Now follow along the steps on the xref:project-docs:sdk-full-installation.adoc#installation[installation page].
