...
Next, edit the https://github.com/maria-robobug/try-cb-python/blob/6.5/travel.py[travel.py] file to reflect the username, password and host that you require. You can also specify commandline arguments at runtime:
...
Note that the sample project uses flask as the web-framework, which you can read more about https://pypi.org/project/Flask/[here].
...
The https://github.com/maria-robobug/try-cb-python/blob/6.5/travel.py[travel.py] file also contains the functions for handling users, registration, and N1QL queries.
