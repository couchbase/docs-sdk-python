...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=api, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=route, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=airport-class-def, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tags=args;connect;start-app, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=user-class-def, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=signup-def, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=signup-code, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tags=login-def;login-code, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=flights-class, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=flights-first-query, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=flights-second-query, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tags=airport-class-def;airports-endpoint, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=booking-doc, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=update-user, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=view-flight-get-keys, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=view-flight-get-details, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=search-query, indent=0]
----
...
[source, python]
----
include::devguide:example$python/sample-app.py[tag=search-subdoc, indent=0]
----
