...
3. Set the environment variable OPENSSL_ROOT_DIR to point to the architecture-specific
subdirectory of the newly checked out tag (amd64 is currently the only supported option).
