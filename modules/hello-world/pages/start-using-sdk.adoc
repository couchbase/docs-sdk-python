...
[source,console]
----
$ sudo yum install gcc gcc-c++ git python3-devel python3-pip cmake openssl-devel
----
...
NOTE: We are working with the link:https://docs.couchbase.com/server/current/manage/manage-settings/install-sample-buckets.html[travel-sample] data bucket.
...
[source,python]
----
include::example$hello_world_t.py[tag=collection,indent=0]
----
...
[source,python]
----
include::example$hello_world_t.py[tag=test-doc,indent=0]
----
...
The following function will _upsert_ a document and print the returned xref:concurrent-document-mutations.adoc[CAS] value:

[source,python]
----
include::example$hello_world_t.py[tag=upsert-func,indent=0]
----
...
[source,python]
----
include::examples$hello_world_t.py[tag=upsert-invoke,indent=0]
----
