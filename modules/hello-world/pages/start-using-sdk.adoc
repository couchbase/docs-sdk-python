...
----
Full details can be found ?????? xref:project-pages:sdk-full-installation.adoc prerequisites / compat
...
// Need to replace this with simplified KV timeout setting  +  admonition.

For developing on Couchbase Capella, if you are not working from the same _Availability Zone_ as your Capella instance, refer to the following:
