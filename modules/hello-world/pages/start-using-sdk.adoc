...
The certificate for connecting to Capella is included in the 4.0 Python SDK.
...
Couchbase {sqlpp} (formerly N1QL) queries are performed by invoking the `Cluster.query()` method.
