...
[source,python]
----
include::devguide:example$python/cloud.py[tags=**]
----
--
...
[source,python]
----
include::devguide:example$python/hello_world_t.py[tags=**]
----
...
----
include::devguide:example$python/cloud.py[tag=imports]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=connect,indent=0]
----
...
[source,python]
----
include::devguide:example$python/hello_world_t.py[tag=connect,indent=0]
----
...
[source,python]
----
include::devguide:example$python/hello_world_t.py[tag=default-collection,indent=0]
----
====
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=get-invoke,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=lookup-func,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=lookup-invoke,indent=0]
----
