= Hello World
:page-aliases: ROOT:getting-started.adoc,ROOT:start-using.adoc,ROOT:hello-couchbase.adoc,ROOT:start-using-sdk.adoc,ROOT:tutorial.adoc
:page-toclevels: 3
:description: Install, connect, try. A quick start guide to get you up and running with Couchbase and the {name-sdk}.
:forum-link: https://www.couchbase.com/forums/c/python-sdk/10
:page-partial:
...
// https://github.com/couchbase/docs-sdk-python/tree/release/4.6/modules/devguide/examples/python
// 
// It can be seen built at
// https://docs.couchbase.com/python-sdk/4.6/hello-world/start-using-sdk.html
...
.Upsert with Replication set to xref:concept-docs:data-durability-acid-transactions.adoc#durable-writes[Majority Durability]:

[source,python]
----
include::devguide:example$python/kv_operations.py[indent=0,tag=durability]
----
...
Details of all build dependencies are in the
...
Details of all build dependencies and platform variations are in the
xref:project-docs:sdk-full-installation.adoc[full installation guide].
The xref:project-docs:compatibility.adoc[compatibility guide] lists compatible OSs and Python versions.
// end::quick-install[]
...
[source,python]
....
include::devguide:example$python/cloud.py[]
....
====
...
`wait_until_ready` is an optional call,
but it is good practice to use it.
Making connections, and opening resources such as buckets, is asynchronous --
that is, the `cluster.bucket` call (below) returns immediately and proceeds in the background.
...
IMPORTANT: The connection code for getting started uses the Administrator password that you were given during set up.
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=bucket,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=collection,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=json,indent=0]
----
////
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=upsert-func,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=test-doc,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=upsert-invoke,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=get-func,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=get-map,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=get-for,indent=0]
----
...
[source,python]
----
include::devguide:example$python//kv_operations.py[tag=get_cas_replace,indent=0]
----
...
[source,python]
----
include::devguide:example$python/cloud.py[tag=replace-named,indent=0]
----
////


When you replace a document, it's usually good practice to use xref:howtos:kv-operations.adoc#optimistic-locking[optimistic locking], as in the above example, using CAS.
...
[source,python]
----
include::devguide:example$python//kv_operations.py[tag=remove_durability,indent=0]
----
