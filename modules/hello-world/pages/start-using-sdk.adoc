...
Couchbase RBAC is fully described in the xref:7.0@server:manage:manage-security/manage-users-and-roles.adoc[Manage Users, Groups, and Roles] page.
...
[source,python]
----
include::example$cloud.py[tag=default-collection,indent=0]
----
...
[source,python]
----
include::example$cloud.py[tag=lookup-func]
----
...
[source,python,indent=0]
----
include::example$cloud.py[tag=lookup-invoke]
----
