...
[source,python]
----
include::devguide:example$python/$caching_flask.py[tag=get]
----

.POST
[source,python]
----
include::devguide:example$python/$caching_flask.py[tag=post]
----
...
[source,python]
----
include::devguide:example$python/$caching_flask.py[tag=put]
----

.DELETE
[source,python]
----
include::devguide:example$python/$caching_flask.py[tag=delete]
----
