...
* Selecting an xref:6.5@server:learn:buckets-memory-and-storage/buckets.adoc#bucket-types[ephemeral bucket] for the advantages of purely in-memory storage may make sense as a design decision.
