...
[source,python]
----
include::devguide:example$python/acouchbase_operations.py[tag=create]
----
...
[source,python]
----
include::devguide:example$python/acouchbase_operations.py[tag=kv]
----

.Sub-document Operations
[source,python]
----
include::devguide:example$python/acouchbase_operations.py[tag=sub_doc]
----

=== Asyncio {sqlpp} Operations

The API for issuing {sqlpp} (formerly N1QL) queries is almost identical to the synchronous API. 
The notable difference is the use of `async for` rather than `for` when iterating over the results.

.{sqlpp} Query
[source,python]
----
include::devguide:example$python/acouchbase_operations.py[tag=n1ql]
----
...
[source,python]
----
include::devguide:example$python/acouchbase_operations.py[tag=search]
----
...
[source,python]
----
include::devguide:example$python/acouchbase_operations.py[tag=analytics]
----
...
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=txcouchbase_imports]
----

.Create a _txcouchbase_ Cluster
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=create]
----
...
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=kv]
----

.Sub-document Operations
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=sub_doc]
----

=== Twisted {sqlpp} Operations

The API for issuing {sqlpp} queries is almost identical to the synchronous API. 
The notable difference is the use of a callback in order to handle iterating over results.

.{sqlpp} Query
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=n1ql]
----
...
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=search]
----
...
[source,python]
----
include::devguide:example$python/txcouchbase_operations.py[tag=analytics]
----
