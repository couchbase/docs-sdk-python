...
:reftext: Distributed ACID Transactions from the Python SDK
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tags=examples;!scope-example,indent=0]
----
...
//[source,java]
//----
//include::devguide:example$python/TransactionsExample.java[tag=logging,indent=0]
//----
//
...
//[source,java]
//----
//include::devguide:example$python/TransactionsExample.java[tag=config_warn,indent=0]
//----
//
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=insert,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=get,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=get_read_own_writes,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=replace,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=remove,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=query_examples_select,indent=0]
----
...
// [source,python]
// ----
// include::devguide:example$python/transactions_example.py[tag=query_examples_select_scope,indent=0]
// ----
...
// [source,python]
// ----
// include::devguide:example$python/transactions_example.py[tag=query_examples_update,indent=0]
// ----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=query_examples_complex,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=query_insert,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=query_options,indent=0]
----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=query_ryow,indent=0]
----
...
//[source,java]
//----
//include::devguide:example$python/TransactionsExample.java[tag=concurrency,indent=0]
//----
...
[source,python]
----
include::devguide:example$python/transactions_example.py[tag=config,indent=0]
----
