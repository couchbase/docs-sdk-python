...
[source,python]
----
include::devguide:example$python/$encrypting_using_sdk.py[tag=keys]
----
...
[source,python]
----
include::devguide:example$python/$encrypting_using_sdk.py[tag=provider]
----
...
[source,python]
----
include::devguide:example$python/$encrypting_using_sdk.py[tag=helper_methods]
----
...
[source,python]
----
include::devguide:example$python/$encrypting_using_sdk.py[tag=save_to_couchbase]
----
...
[source,python]
----
include::devguide:example$python/$encrypting_using_sdk.py[tag=output_encrypted_doc]
----
...
[source,python]
----
include::devguide:example$python/$encrypting_using_sdk.py[tag=decrypt_doc]
----
