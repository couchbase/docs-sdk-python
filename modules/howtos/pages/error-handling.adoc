...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=generic_try_catch]
----
...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=retries]
----
...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=DocumentNotFoundException]
----
...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=DocumentExistsException]
----
...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=CASMismatchException]
----
...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=DurabilitySyncWriteAmbiguousException]
----
...
[source,python]
----
include::devguide:example$python/error_handling.py[tag=QueryErrorContext]
----
