...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=search_basic_example]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=search_result]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=search_query_search]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=limit_and_skip]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=scan_consistency]
----

.ConsistentWith consistency example:
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=ryow]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=highlight]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=sort]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=facets]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=fields]
----
...
[source,python]
----
include::devguide:example$python/$search_ops.py[tag=collections]
----
...
[source,python]
----
include::devguide:example$python/$acouchbase_search_ops.py[tag=simple_query]
----

.TxCouchbase
[source,python]
----
include::devguide:example$python/$txcouchbase_search_ops.py[tag=simple_query]
----
