...
[source,python]
----
include::devguide:example$python/health_check.py[tag=cluster_ping_latency]
----
...
[source,python]
----
include::devguide:example$python/health_check.py[tag=cluster_ping_as_json]
----
...
[source,python]
----
include::devguide:example$python/health_check.py[tag=check_connection]
----
...
[source,python]
----
include::devguide:example$python/health_check.py[tag=cluster_ping_n1ql]
----
...
[source,python]
----
include::devguide:example$python/health_check.py[tag=cluster_diagnostics]
----
