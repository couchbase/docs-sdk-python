...
The complete code sample used on this page can be downloaded from https://github.com/couchbase/docs-sdk-python/blob/release/{sdk_dot_minor}/modules/howtos/examples/kv_operations.py[the GitHub repo for the Python docs], from which you can see in context how to authenticate and connect to a Couchbase Cluster, then perform these Collection operations.
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=insert]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=insert_w_opts]
----
...
----
include::devguide:example$python/$kv_operations.py[tag=replace_cas]
----
...
[source,python,indent=0]
----
include::devguide:example$python/$kv_operations.py[tag=get_cas_replace]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=durability]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=obs_durability]
----
...
IMPORTANT: Preferred Server Group Replica Reads are only accessible with the {name-sdk} working with Couchbase Server 7.6.2 or newer (Capella or self-managed), from SDK version 4.4.0.
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=get]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=get_timeout]
----
...
[source,python,indent=0]
----
include::devguide:example$python/$kv_operations.py[tag=remove_durability]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=touch]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=get_expiry]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=get_and_touch]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=increment]
----

.Increment (with seed)
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=increment_w_seed]
----

.Decrement
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=decrement]
----

.Decrement (with seed)
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=decrement_w_seed]
----
...
[source,python]
----
include::devguide:example$python/$kv_range_scan.py[tag=range_scan_all_documents]
----
...
[source,python]
----
include::devguide:example$python/$kv_range_scan.py[tag=range_scan_prefix]
----
...
[source,python]
----
include::devguide:example$python/$kv_range_scan.py[tag=range_scan_sample]
----
...
[source,python]
----
include::devguide:example$python/$kv_range_scan.py[tag=range_scan_all_document_ids]
----
...
[source,python]
----
include::devguide:example$python/$kv_operations.py[tag=named-collection-upsert,indent=0]
----
