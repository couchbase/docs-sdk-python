...
[source,python]
----
include::howtos:example$kv_range_scan.py[tag=range_scan_all_documents]
----
...
[source,python]
----
include::howtos:example$kv_range_scan.py[tag=range_scan_prefix]
----
...
[source,python]
----
include::howtos:example$kv_range_scan.py[tag=range_scan_sample]
----
...
[source,python]
----
include::howtos:example$kv_range_scan.py[tag=range_scan_all_document_ids]
----
