...
Couchbase Data Platform 6.5 refines these two options, with xref:concep-docs:durability-replication-failure-considerations.adoc[Synchronous Replication].
