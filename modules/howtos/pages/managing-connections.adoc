...
Navigate in the admin UI to menu:Security[Client Certificate] and copy the input box of the TLS certificate into a file on your machine (which we will refer to as `cluster.crt`).
