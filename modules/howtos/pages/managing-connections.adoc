...
You can force waiting for the resource to be opened with a call to `waitUntilReady`, which is available on both the `Cluster` and `Bucket` -- and used in the connect examples above on the Cluster.
...
[source,python]
----
include::devguide:example$python/managing_connections.py[tag=customenv,indent=0]
----
////
...
[source,python]
----
include::devguide:example$python/managing_connections.py[tag=shareclusterenvironment,indent=0]
----
...
// using the overloaded `Cluster.connect()` method that takes a set of `SeedNode` objects instead of a connection string.

// todo use the include (and uncomment in ManageingConnections.python) after next client snapshot is published
// https://github.com/couchbase/docs-sdk-python/blob/temp/4.5/modules/howtos/examples/managing_connections.py#L86
// include::devguide:example$python/managing_connections.py[tag=seednodes,indent=0]
[source,python]
----
...
[source,python]
----
include::devguide:example$python/managing_connections.py[tag=blockingtoasync,indent=0]
----
...
[source,python]
----
include::devguide:example$python/managing_connections.py[tag=asynccluster,indent=0]
----
...
[source,python]
----
include::devguide:example$python/managing_connections.py[tag=reactivecluster,indent=0]
----
////
