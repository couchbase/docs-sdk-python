...
// API refs
:bucket-api-reference: pass:q[BucketManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.cluster.Cluster.buckets[`Cluster.buckets()`]]
:user-api-reference: pass:q[UserManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.cluster.Cluster.users[`Cluster.users()`]]
:query-api-reference: pass:q[QueryIndexManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.cluster.Cluster.query_indexes[`Cluster.query_indexes()`]]
:analytics-api-reference: pass:q[AnalyticsIndexManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.cluster.Cluster.query_indexes[`Cluster.analytics_ndexes()`]]
:search-api-reference: pass:q[SearchIndexManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.cluster.Cluster.query_indexes[`Cluster.search_indexes()`]]
:collection-api-reference: pass:q[CollectionManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.bucket.Bucket.collections[`Bucket.collections()`]]
:view-api-reference: pass:q[ ViewIndexManager -- https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html#couchbase.bucket.Bucket.collections[`Bucket.view_indexes()`]]
...
[source,python]
----
include::devguide:example$python/provisioning_resources_buckets.py[tag=create_bucket_mgr]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_buckets.py[tag=create_bucket]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_buckets.py[tag=get_and_update_bucket]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_buckets.py[tag=drop_bucket]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_buckets.py[tag=flush_bucket]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_collections.py[tag=create_collections_mgr]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_collections.py[tag=create_scope]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_collections.py[tag=create_collection]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_collections.py[tag=drop_collection]

include::devguide:example$python/provisioning_resources_collections.py[tag=drop_scope]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_collections.py[tag=scopeAdmin]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_collections.py[tag=listing-scope-collection]
----
...
[source,python]
----
include::devguide:example$python/query_index_manager.py[tag=creating-index-mgr,indent=0]
----
...
[source,python]
----
include::devguide:example$python/query_index_manager.py[tag=primary,indent=0]
----
...
[source,python]
----
include::devguide:example$python/query_index_manager.py[tag=secondary,indent=0]
----
...
[source,python]
----
include::devguide:example$python/query_index_manager.py[tag=defer-indexes,indent=0]
----
...
[source,python]
----
include::devguide:example$python/query_index_manager.py[tag=drop-primary-or-secondary-index,indent=0]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_views.py[tag=create_view_mgr]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_views.py[tag=create_view]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_views.py[tag=get_view]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_views.py[tag=publish_view]
----
...
[source,python]
----
include::devguide:example$python/provisioning_resources_views.py[tag=drop_view]
----
