...
[source,python]
----
include::devguide:example$python/$provisioning_resources_users.py[tag=create_user]
----

.Listing Users
[source,python]
----
include::devguide:example$python/$provisioning_resources_users.py[tag=get_all_users]
----
...
[source,python]
----
include::devguide:example$python/$provisioning_resources_users.py[tag=user_operations]
----
