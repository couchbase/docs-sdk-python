...
Fuller examples can be found in the https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_core.html?highlight=collection%20mutate_in#couchbase.collection.Collection.mutate_in[API reference doc].
