...
Refer to the https://docs.couchbase.com/sdk-api/couchbase-python-client/api/couchbase.html?highlight=persist#item-api-methods[API docs] for the legacy API.
