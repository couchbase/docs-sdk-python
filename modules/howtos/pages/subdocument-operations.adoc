...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=lookup_in]
----

.Check existence of sub-document path
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=lookup_in_exists]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=lookup_in_multi]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=mutate_in_upsert]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=mutate_in_insert]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=combine_dict]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=array_append]
----

[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=array_prepend]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=create_array]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=add_multi]
----

.Add single array as element to existing array
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=add_nested_array]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=add_multi_slow]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=create_parents_array]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=array_addunique]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=array_insert]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=counter1]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=counter2]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=create_parents]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=lookup_in_any_replica]
----
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=lookup_in_all_replicas]
----

You may want to use `lookup_in_all_replicas` to build a consensus,
but it's more likely that you'll make use of `lookup_in_any_replica` as a fallback to a `lookupIn`, when the active node times out.
...
[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=cas1]
----

[source,python]
----
include::devguide:example$python/subdocument_ops.py[tag=cas2]
----
...
----
include::devguide:example$python/subdocument_ops.py[tag=cas3]
----
...
[source,python,indent=0]
----
include::devguide:example$python/subdocument_ops.py[tag=obs_durability]
----
...
[source,python,indent=0]
----
include::devguide:example$python/subdocument_ops.py[tag=durability]
----
