...
If you wish to create an array if it does not exist and also push elements to it within the same operation you may use the <<subdoc_create_path,_create-path_>> option:
...
Refer to the https://docs.couchbase.com/sdk-api/couchbase-python-client/api/couchbase.html?highlight=persist#informational-methods[API docs] for the legacy API.
