...
[source,python]
----
include::devguide:example$python/transcoders.py[tag=raw_json_encode]
----
...
[source,python]
----
include::devguide:example$python/transcoders.py[tag=raw_json_decode]
----
...
[source,python]
----
include::devguide:example$python/transcoders.py[tag=raw_string_transcoder]
----
...
[source,python]
----
include::devguide:example$python/transcoders.py[tag=raw_binary_transcoder]
----
...
[source,python]
----
include::devguide:example$python/transcoders.py[tag=create_custom_transcoder]
----
...
[source,python]
----
include::devguide:example$python/transcoders.py[tag=use_custom_transcoder]
----
