...
[source,python]
----
include::devguide:example$python/search_ops.py[tag=vector_search_single]
----
...
[source,python]
----
include::devguide:example$python/search_ops.py[tag=vector_search_prefilter]
----
...
[source,python]
----
include::devguide:example$python/search_ops.py[tag=vector_search_prefilter_query_str]
----
...
[source,python]
----
include::devguide:example$python/search_ops.py[tag=vector_search_multi]
----
...
[source,python]
----
include::devguide:example$python/search_ops.py[tag=vector_search_combo]
----
