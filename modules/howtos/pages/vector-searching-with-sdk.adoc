...
[source,python]
----
include::howtos:example$search_ops.py[tag=vector_search_single]
----
...
It returns the same `SearchResult` detailed on the xref:full-text-searching-with-sdk.adoc[Search page].
...
[source,python]
----
VectorQuery(field_name, vector, num_candidates=None, boost=None, prefilter=SearchQuery)
----
...
[source,python]
----
VectorQuery("color_wheel_pos", vector, num_candidates=numCandidates, prefilter={MatchQuery: "primary"})
----
...
[source,python]
----
VectorQuery("+description:sea -color_hex:fff5ee", vector, num_candidates=numCandidates, prefilter={MatchQuery: "primary"})
----
...
[source,python]
----
include::howtos:example$search_ops.py[tag=vector_search_multi]
----
...
[source,python]
----
include::howtos:example$search_ops.py[tag=vector_search_combo]
----
...
* Vector GSI Query is just like any other query from the SDK to the Query service: 
https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_n1ql.html[Python SDK API Reference, Query Service page].
...
* Vector Search in the https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/couchbase_search.html#module-couchbase.vector_search[Python API reference].
