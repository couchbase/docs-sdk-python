...
[cols="40,25,20,20,30"]
|===
| | SDK 2.3 | SDK 2.4 | SDK 2.5  | SDK 3.0, 3.1
...
Python SDK *3.0.10* is the latest version compatible with Server 7.0β.

Later SDK 3.x releases will be limited to the Default Scope and Collection with the beta 7.0 server, and will only be fully compatible with the full release version.
====
