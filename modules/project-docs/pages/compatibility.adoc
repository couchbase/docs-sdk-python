...
| Scope-Level {sqlpp} (N1QL) Queries & all Collections features
2+| Not Supported
2+| Since SDK 3.2.0
...
This means official support for AWS Lambda, Azure Functions, and GCP Functions -- _from xref:4.1@python-sdk:project-docs:compatibility.adoc#serverless-environments[Python SDK 4.1.0]_.
