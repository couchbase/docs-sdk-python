...
* The changes to xref:howtos:managing-connections.adoc#connection-strings[Connection Strings] can be found documented in the https://docs.couchbase.com/sdk-api/couchbase-python-client-4.0.5/couchbase_api/options.html#cluster[API reference].
