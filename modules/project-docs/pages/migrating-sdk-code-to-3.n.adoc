...
For the most part, migration from 2.x versions remains the same -- the few 4.0-specific changes can be found at the end of this document.
...
////
IMPORTANT: Python SDK 3.x has a minimum required Python version of 3.5, although we recommend running the latest version (i.e. at the time of writing Python 3.8) with the highest patch version available.
