...
----
include::devguide:example$python/migrating.py[tag=timeoutbuilder,indent=0]
----
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=sysprops,indent=0]
// ----
////

[source,python]
----
include::devguide:example$python/migrating.py[tag=connstr,indent=0]
----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=rbac,indent=0]
----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=rbac-full,indent=0]
----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=certauth,indent=0]
----
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=simpleget,indent=0]
// ----
////
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=upsertandget_sdk2,indent=0]
// ----

// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=upsertandget,indent=0]
// ----

// //[source,python]
// //----
// //include::devguide:example$python/migrating.py[tag=rawjson,indent=0]
// //----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=customtimeout,indent=0]
----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=querysimple_sdk2,indent=0]
----

[source,python]
----
include::devguide:example$python/migrating.py[tag=querysimple,indent=0]
----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=queryparameterized_sdk2,indent=0]
----

[source,python]
----
include::devguide:example$python/migrating.py[tag=queryparameterized,indent=0]
----
...
[source,python]
----
include::devguide:example$python/migrating.py[tag=analyticssimple,indent=0]
----

[source,python]
----
include::devguide:example$python/migrating.py[tag=analyticsparameterized,indent=0]
----
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=errorcheck_sdk2,indent=0]
// ----

// [source]
// ----
// include::devguide:example$python/migrating.py[tag=errorcheck,indent=0]
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=searchsimple,indent=0]
// ----
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=searchcheck,indent=0]
// ----
////
...
// [source,python]
// ----
// include::devguide:example$python/migrating.py[tag=viewquery,indent=0]
// ----
