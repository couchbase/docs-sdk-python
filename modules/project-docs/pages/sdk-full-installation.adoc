...
This guide assumes you have some familiarity with development using Python -- if you are evaluating the SDK as a software architect, tester, or other non-Python role, you may benefit from our xref:hello-world:platform-help.adoc#[Platform Help page].
