...
[source,bash]
----
pip install couchbase==3.0.9
----

*API Docs:* http://docs.couchbase.com/sdk-api/couchbase-python-client-3.0.9/
...
The new expiryTime field is returning a float to represent the expiration, rather than a datetime.  Discovered too
late for 3.0.9, this will be fixed in the next release.
