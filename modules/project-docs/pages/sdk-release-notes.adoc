...
User Management quick snippets

* https://issues.couchbase.com/browse/PYCBC-956[PYCBC-956]:
Add Bucket Durability Creation Support
...
Add support to pass Score as FTS parameter
