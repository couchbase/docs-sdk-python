...
Version 4.3.2 is the next patch release of the fourth generation Python SDK, bringing a number of improvements. Most notably the 4.3.2 release adds support for Python 3.12.  See https://docs.couchbase.com/python-sdk/current/project-docs/compatibility.html#python-version-compat[Python Version Compatibility] for details on supported Python versions.
...
The Couchbase Python SDK will soon stop providing Python 3.8 wheels as Python 3.8 reaches https://peps.python.org/pep-0569/#lifespann[end-of-life] in October 2024. See https://docs.couchbase.com/python-sdk/current/project-docs/compatibility.html#python-version-compat[Python Version Compatibility] for details on supported Python versions.
