...
This release deprecates the legacy `IxmgmtRequest` and `BucketManager` classes.  The updated https://docs.couchbase.com/sdk-api/couchbase-python-client/#management-apis>[Management APIs] should be used instead.
...
Add support for get_all_replicas to return ACTIVE as well
...
acouchbase - Management APIs: Bucket, Collection, User and Query Index.
