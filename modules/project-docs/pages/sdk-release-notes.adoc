...
Allow result sets greater than 1000 (acouchbase API)

* https://issues.couchbase.com/browse/PYCBC-1171[PYCBC-1171]:
Decrement callback references (txcouchbase API)
