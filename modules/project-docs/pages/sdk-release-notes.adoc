...
Fixed `InternalServerFailureException` when executing a `Regex` FTS query

* https://issues.couchbase.com/browse/PYCBC-1493[PYCBC-1493]:
Updated search operations to correctly pass MutationState to C++ core

=== Enhancements

* https://issues.couchbase.com/browse/PYCBC-1488[PYCBC-1488]:
Added dump_configuration `ClusterOption`
