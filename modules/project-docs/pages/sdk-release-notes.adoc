...
Migrate datastructures to SDK3

* https://issues.couchbase.com/browse/PYCBC-595[PYCBC-595]:
Implement multi-ops in Collection class

* https://issues.couchbase.com/browse/PYCBC-596[PYCBC-596]:
Centralise Collections/Bucket functionality

* https://issues.couchbase.com/browse/PYCBC-597[PYCBC-597]:
Add buckets_list function to documentation index
...
Be sure to xref:2.10@c-sdk::relnotes-c-sdk.adoc[upgrade your LCB installation] before making a major upgrade to the Couchbase Python client.
