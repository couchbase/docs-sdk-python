...
CI: Updateed GoCAVES download url to use arm64 version when appropriate

https://jira.issues.couchbase.com/browse/PYCBC-1646[PYCBC-1646]:
Migrated transactions to us transaction_context
...
Transactions - Fix memory leak when creating TransactionGetResult
