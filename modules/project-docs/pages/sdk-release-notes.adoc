...
KV and Query latency ~30% higher than SDK 2.x with external libcouchbase installed
...
Flask references missing from latest docs
...
Handle change in how existing scope is reported by Cheshire Cat
