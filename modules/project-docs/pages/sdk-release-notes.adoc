...
https://jira.issues.couchbase.com/browse/PYCBC-1685[PYCBC-1685]:
Removed timeout logic when waiting for C++ core HTTP response.
...
Add num_vbuckets to bucket_settings (https://github.com/couchbase/couchbase-cxx-client/pull/746[#746])
