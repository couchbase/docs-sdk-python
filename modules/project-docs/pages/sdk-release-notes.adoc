...
== Python SDK 3.0.0 Beta 4 (RC) Release Notes (April 3 2020)

[source,bash]
----
pip install couchbase==3.0.0b4
----

*API Docs:* http://docs.couchbase.com/sdk-api/couchbase-python-client-3.0.0b4/
