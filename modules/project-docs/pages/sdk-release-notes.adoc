...
== Python SDK 3.0.0 Beta 3 Release Notes (January 17 2019)
...
Bump LCB requirement to 3.0.0

* https://issues.couchbase.com/browse/PYCBC-757[PYCBC-757]:
Refactor for FTS/N1QL/durability LCB changes

* https://issues.couchbase.com/browse/PYCBC-758[PYCBC-758]:
Reflect renaming of lcb_wait3 to lcb_wait in LCB
...
Upsert Group fails with 'roles: value must be supplied'
...
Conform Result objects to RFC, remove unidiomatic interfaces
...
Collection APIs should be marked volatile

* https://issues.couchbase.com/browse/PYCBC-763[PYCBC-763]:
Correct MutateInResult.content_as implementation

* https://issues.couchbase.com/browse/PYCBC-764[PYCBC-764]:
Delete or rename remaining SDK2 references in main API

* https://issues.couchbase.com/browse/PYCBC-704[PYCBC-704]:
Implement *CollectionOptions for Collection management API
