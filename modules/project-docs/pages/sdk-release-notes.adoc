...
== Version 3.0.4 (22 July 2020)

[source,bash]
----
pip install couchbase==3.0.4
----
...
Removed support for Python <3.5 -- 3.5 is the minimum supported version of Python.

* https://issues.couchbase.com/browse/PYCBC-983[PYCBC-983]:
Made Conan/PyGithub deps contingent on build reqs, reducing mandatory build deps.

* https://issues.couchbase.com/browse/PYCBC-987[PYCBC-987]:
Fixed 'ImportError: DLL load failed' error on Windows with SSL -- SSL is now loaded before LCB.

== Version 3.0.3 (15 July 2020)

[source,bash]
----
pip install couchbase==3.0.3
----
