...
Add AnalyticsScanConsistency

=== Enhancements

* https://issues.couchbase.com/browse/PYCBC-1011[PYCBC-1011]:
If tests.ini not in current dir, use base path of PYCBC distro.

* https://issues.couchbase.com/browse/PYCBC-1016[PYCBC-1016]:
Reenable non-hybrid build for CLion
