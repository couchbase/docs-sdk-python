...
Update QueryIndexManagement API to use LCB HTTP methods

* https://issues.couchbase.com/browse/PYCBC-1189[PYCBC-1189]:
Add redeploy_required property to EventingFunctionStatus
