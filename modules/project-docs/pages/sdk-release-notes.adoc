...
Updated eventing function management to ignore new fields in JSON responses from server.

=== Enhancements

* https://issues.couchbase.com/browse/PYCBC-1222[PYCBC-1222]:
Improved Query error handling by adding an `error_response_body` field to `QueryErrorContext`.
