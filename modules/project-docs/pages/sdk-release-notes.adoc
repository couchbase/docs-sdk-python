...
For example, to install version 4.3.6:
...
This version of the SDK does not propagate a small number of `ClusterOptions` to the {cpp} core. This will be fixed in the next patch release (4.6.1).
